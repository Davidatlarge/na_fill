...
### Arguments
  ...
  *fill.ends* -- logical, should leading and tailing NAs be filled (only NA groups up to maxgap will be filled), defaults to FALSE
  
### Details

Using maxgap = 0 replaces no NAs, which might be useful when using the function in a loop.
